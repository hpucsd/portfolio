...
// Ensure pie chart updates with filtered projects on search input change
searchInput.addEventListener('input', (event) => {
  let filteredProjects = setQuery(event.target.value); // Ensure this returns filtered data
  renderProjects(filteredProjects, document.querySelector('.projects-container'), 'h2');
